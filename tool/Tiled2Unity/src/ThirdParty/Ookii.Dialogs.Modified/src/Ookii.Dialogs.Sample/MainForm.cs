...
namespace Ookii.Dialogs.Sample
{
    public partial class MainForm : ExtendedForm
    {
        ...
        // Seanba: Added this for testing a Unity project folder.
        private void _sampleVistaFolderBrowserDialog_OnFolderSelected(VistaFolderBrowserDialog dlg, string path)
        {
