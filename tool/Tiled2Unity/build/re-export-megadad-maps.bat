...
call re-export-single-map.bat "..\..\..\unity\Tiled2Unity\tiled\simple\MagmaManLairNoCollision.tmx"
call re-export-single-map.bat "..\..\..\unity\Tiled2Unity\tiled\simple\MagmaManLairWithCollision.tmx"
